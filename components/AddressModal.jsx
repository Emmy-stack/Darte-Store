...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), { loading: 'Adding Address...', success: 'Address added', error: (err) => err.message || 'Failed' })} className="fixed inset-0 z-50 bg-white/60 backdrop-blur h-screen flex items-center justify-center">
