    ...
    return (
        <>
                        ...
                        <tbody className="divide-y divide-gray-100">
                            {orders.map((order, index) => (
                                ...
                                >
                                    ...
                                    <td className="px-4 py-3 font-medium text-slate-800">{currency}{formatPrice(order.total)}</td>
                                    ...
                                    <td className="px-4 py-3" onClick={(e) => { e.stopPropagation() }}>
                                        {['DELIVERED', 'DELIVERY_CONFIRMED', 'DELIVERY_DENIED'].includes(order.status) ? (
                                            ...
                                            <select
                                                ...
                                                disabled={updating}
                                                className="border border-gray-300 rounded-md text-sm px-2 py-1 focus:ring focus:ring-blue-200 disabled:bg-gray-100 disabled:cursor-not-allowed"
                                            >
            ...
            {pendingDeliveryOrder && (
                <div onClick={() => setPendingDeliveryOrder(null)} className="fixed inset-0 flex items-center justify-center bg-black/50 text-slate-700 text-sm backdrop-blur-xs z-50 animate-in fade-in duration-200">
